...
using System; 
using System.IO; 
using SistemaUniversidadv1._0.Filtros; // Importa los filtros personalizados definidos en la aplicación 
...
namespace SistemaUniversidadv1._0.Controllers 
{
    ...
    public class ProfesorController : Controller
    {
        ...
        public ActionResult MateriasAsignadas(int? carreraId) // Acción que maneja la vista de las materias asignadas al profesor. Recibe un parámetro opcional carreraId
        {
            ...
            if (rolId != 3) // Si el rol no es el de "Profesor" ("3" es el ID del rol de Profesor)
            {
        ...
        public ActionResult EstudiantesPorMateria(int idMateria) // Acción que muestra los estudiantes inscritos en una materia específica
        {
            ...
            // Obtiene los estudiantes inscritos en una materia especifica
            ...
            // la informacion de la materia se guarda en el ViewBag para usar en la vista
